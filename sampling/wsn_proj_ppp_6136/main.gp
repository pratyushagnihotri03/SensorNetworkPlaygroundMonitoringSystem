...
set output "temp.eps"
plot "temperature_6136.dat" using 1:2 axes x1y1 with lines ls 1 title "{/Arial=14 Temperature}"


set ylabel "Light [lux]"
set style line 1 lt 1 lc rgb "blue" lw 2 pt 1
set output "light.eps"
plot "light_6136.dat" using 1:2 axes x1y1 with lines ls 1 title "{/Arial=14 Light)}"

set ylabel "Humidity [%]"
set style line 1 lt 1 lc rgb "green" lw 2 pt 1
set output "humidity.eps"
plot "humidity_6136.dat" using 1:2 axes x1y1 with lines ls 1 title "{/Arial=14 Humidity}"

set ylabel "Soil Moisture (kalanchoe) [VWT]"
set style line 1 lt 1 lc rgb "olive" lw 2 pt 1
set output "soil_kalanchoe.eps"
plot "soil_kalanchoe_6136.dat" using 1:2 axes x1y1 with lines ls 1 title "{/Arial=14 Soil Moisture(Kalanchoe)}"

set ylabel "Soil Moisture(peperomia) [VWT]"
set style line 1 lt 1 lc rgb "olive" lw 2 pt 1
set output "soil_peperomia.eps"
plot "soil_peperomia_6136.dat" using 1:2 axes x1y1 with lines ls 1 title "{/Arial=14 Soil Moisture (Peperomia)}"

set ylabel "CO2 [PPM]"
set style line 1 lt 1 lc rgb "brown" lw 2 pt 1
set output "co2.eps"
plot "co2_6136.dat" using 1:2 axes x1y1 with lines ls 1 title "{/Arial=14 CO2}"
